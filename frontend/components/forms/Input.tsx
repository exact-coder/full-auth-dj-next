...
export default function Input({children,labelId,type,onChange,value,required=false}:Props) {
  return (
    <div>
              <label htmlFor={labelId} className="block text-sm font-medium leading-6 text-white">
                {children}
              </label>
              <div className="mt-2">
                <input
